...
\ifdefined\isepub
  % EPUB PIPELINE: Output a clean structural block for CSS to hook into
  \newcommand{\systemcall}[1]{\begin{systemcallenv}#1\end{systemcallenv}}
\else
  % PDF PIPELINE: Your original TikZ vector artwork
...
\begin{flushleft}
    ...
    {\headerfont\small A Novel of Metabolic War} \\
    \vspace{2ex}
